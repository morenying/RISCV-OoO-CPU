//==============================================================================
// Minimal CPI Test - Just IF/ID/RN stages
//==============================================================================
`timescale 1ns/1ps

module tb_cpi_minimal;
    ...
    always @(posedge clk) begin
        if (rst_n && cycle_count <= 100) begin
            if (commit_valid)
                $display("[%0d] COMMIT: pc=%h", cycle_count, commit_pc);
        end
        if (cycle_count == 100) begin
            $display("=== 100 cycles done ===");
            $finish;
        end
    end
