//==============================================================================
// Simple CPI Test - Minimal version for quick testing
//==============================================================================
`timescale 1ns/1ps

module tb_cpi_simple_test;
    ...
    // Simple AXI I-Bus - immediate response
    ...
    // Count instructions via AXI reads
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            instr_count <= 0;
            cycle_count <= 0;
            ...
            if (m_axi_ibus_rvalid && m_axi_ibus_rready)
    ...
    initial begin
        ...
        // Load simple program: 5 ADDIs then EBREAK
        ...
        $display("Results after 200 cycles:");
        $display("  Cycles: %0d", cycle_count);
        $display("  Instructions fetched: %0d", instr_count);
        if (instr_count > 0)
            $display("  CPI: %0.2f", cycle_count * 1.0 / instr_count);
