...
module free_list #(
    ...
    assign alloc_valid_o = alloc_req_i && !empty_o;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            head <= 6'd32;  // First free register
            tail <= 6'd0;   // Next write position (wraps around)
            count <= 6'd32; // 32 free registers (P32-P63)
            
            // Initialize FIFO with free registers P32-P63
